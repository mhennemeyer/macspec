module MacSpec
  module Modals
    ...
    def should(expectation = nil)
      MacSpec::ExpectationBuilder.build_expectation(true, expectation, self)
    end
    ...
    def should_not(expectation = nil)
      MacSpec::ExpectationBuilder.build_expectation(false, expectation, self)
    end
...
Object.send(:include, MacSpec::Modals)