  ...
  module Kernel
    def describe(*args, &block)
      ...
      super_class.class_eval {extend MacSpec::Testing::TestCaseClassMethods}
      $macspec_superclass = super_class # todo track this otherwise
      cls = Class.new(super_class)
      cnst, desc = args
      cnst = MacSpec::Testing::Functions.make_constantizeable(cnst)
      Object.const_set MacSpec::Testing::Functions::determine_class_name(cnst.to_s + "Test"), cls
